...
class Address(models.Model):
    ...
    country = models.CharField(choices=COUNTRIES, max_length=200, null=True, blank=True)
...
class  CompanyDetails(models.Model):
    ...
    logo = models.FileField(default="static/portal/logo.jpg", upload_to="images", null=True, blank=True)
    manager = models.ForeignKey("portal.AdminUser", default=1, null=True, blank=True, on_delete=models.CASCADE)
