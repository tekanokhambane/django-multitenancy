...
class InviteView(LoginRequiredMixin, FormMixin, View):
    ...
    invite_form_fragment = "multitenancy/invitations/_invite_form.html"
    invites_remaining_fragment = "multitenancy/invitations/_invites_remaining.html"
    invited_fragment = "multitenancy/invitations/_invited.html"
    invites_remaining_fragment_selector = ".multitenancy-invitations-invites-remaining"
    invited_fragment_selector = ".multitenancy-invitations-invites-sent"
...
class ManageInvitesView(LoginRequiredMixin, View):
    ...
    @method_decorator(
        permission_required(
            "multitenancy-invitations.manage_invites", raise_exception=True
        )
    )
...
class UserManageInviteAmountsView(ManageInviteAmountsView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return JsonResponse({"html": amount})
